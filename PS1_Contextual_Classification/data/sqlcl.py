...
### Changed default urls to DR9 - Darryl Wright 24 March 2015 ###
#astro_url='http://cas.sdss.org/dr9/en/tools/search/x_sql.asp'
public_url='http://cas.sdss.org/dr9/en/tools/search/x_sql.asp'
...
def main(argv):
    ...
    for qry in queries:
        ...
        ### added sleep to accomodate 60 queries per min rule - Darryl Wright 24 March 2015 ###
        time.sleep(2)
        ...
        line = file.readline()
        while line:
            ofp.write(qry.split(" = ")[-1].rstrip()+","+string.rstrip(line)+os.linesep)
            line = file.readline()
